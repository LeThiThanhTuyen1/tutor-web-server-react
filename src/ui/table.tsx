...
const TableFooter = React.forwardRef<HTMLTableSectionElement, React.HTMLAttributes<HTMLTableSectionElement>>(
  ({ className, ...props }, ref) => (
    <tfoot
      ref={ref}
      className={cn("bg-indigo-50 dark:bg-indigo-900/20 font-medium text-indigo-900 dark:text-indigo-50", className)}
      {...props}
    />
  ),
)
...
const TableCaption = React.forwardRef<HTMLTableCaptionElement, React.HTMLAttributes<HTMLTableCaptionElement>>(
  ({ className, ...props }, ref) => (
    <caption ref={ref} className={cn("mt-4 text-sm text-indigo-500 dark:text-indigo-400", className)} {...props} />
  ),
)
