    ...
    >
      <div className="space-y-4">
          ...
          <div className="space-y-4">
            <div>
              ...
              <p className="text-sm mb-1">
                <span className="font-semibold">Party A (Tutor):</span>{" "}
                {tutorName}
              </p>
              <p className="text-sm">
                <span className="font-semibold">Party B (Student):</span>{" "}
                {studentName}
              </p>
            </div>
            ...
            <div>
              ...
              <div className="text-sm space-y-2 text-gray-700 dark:text-gray-300">
                ...
                <p>
                  ...
                  agrees to pay the course fee as specified above. Payment must
                  be made according to the payment schedule provided.
                </p>
                <p>
                ...
                <p>
                  ...
                  Student may cancel enrollment within 48 hours of signing this
                  agreement for a full refund. After this period, refunds will
                  be subject to the cancellation policy.
                </p>
                <p>
                  5. <span className="font-medium">Course Materials:</span> All
                  course materials provided by the Tutor are for the Student's
                  personal use only and may not be reproduced or distributed.
                </p>
                <p>
        ...
        <div className="pt-4 flex items-start gap-2">
          ...
          >
            I have read and agree to the terms and conditions of this enrollment
            contract.
          </label>
        </div>
      </div>
