                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    >
                      <span className="mr-1 text-xs">
                        {currentView === "daily" ? "Next Day" : "Next Week"}
                      </span>
                        ...
                        >
                          <div className="flex flex-col space-y-2">
                            <div className="flex justify-between items-start">
                              ...
                              <div className="text-sm px-2 py-0.5 rounded bg-indigo-100 text-indigo-800 dark:bg-indigo-900/30 dark:text-indigo-300">
