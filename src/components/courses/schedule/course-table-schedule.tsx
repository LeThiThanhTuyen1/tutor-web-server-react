                ...
                processedCourses.map((course) => (
                  ...
                  >
                    ...
                    <TableCell className="p-2 align-top">
                      <Badge
                        variant="outline"
                        className={cn("text-xs", STATUS_STYLES[course.status])}
                      >
                      ...
                      <div className="space-y-2">
                        {course.schedule.map((schedule, idx) => (
                          ...
                          >
                            ...
                            {schedule.hasConflict &&
                              schedule.conflictingCourses && (
                                <div className="mt-1 text-yellow-600 dark:text-yellow-400 text-[13px]">
                                  <AlertTriangle className="h-2.5 w-2.5 inline mr-0.5" />
                                  <span>
                                    Conflicts with:{" "}
                                    {schedule.conflictingCourses.join(", ")}
                                  </span>
                                </div>
                              )}
                          </div>
