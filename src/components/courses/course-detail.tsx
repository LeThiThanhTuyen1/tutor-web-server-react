...
export default function CourseDetail() {
  ...
  const handleCancelCourse = async () => {
    ...
    try {
      ...
      toast({
        title: "Success",
        description: "The course has been successfully canceled",
        variant: "success",
      });
    } catch (error) {
      toast({
  ...
  const handleEnrollCourse = async () => {
    ...
    try {
      ...
      if (response.succeeded) {
        ...
        toast({
          title: "Error",
          description: response.message || "Unable to enroll in the course",
          variant: "destructive",
        });
      }
    } catch (error) {
              ...
              <Card className="border border-indigo-100 dark:border-indigo-900 overflow-hidden bg-white dark:bg-gray-800">
                ...
                <CardHeader className="pb-2">
                  ...
                  <div className="flex items-center mt-2 text-sm text-gray-600 dark:text-gray-400">
                    ...
                    <span>{totalStudents || 0} enrolled </span>
                  </div>
                </CardHeader>
                <CardContent>
                  <p className="text-gray-600 dark:text-gray-400 mb-6">
                      ...
                      <div className="space-y-6">
                        ...
                        <div>
                          ...
                          <ul className="list-disc pl-5 space-y-2 text-gray-600 dark:text-gray-400">
                            ...
                            <li>Access to necessary software or tools</li>
                            <li>
                    ...
                    <TabsContent value="schedule" className="p-6">
                      {hasSchedules ? (
                        ...
                        <div className="text-center py-8 text-gray-500 dark:text-gray-400">
                          ...
                          <p>
                            There is no schedule information for this course.
                          </p>
                        </div>
                      )}
                    </TabsContent>
                      ...
                      <TabsContent value="students" className="p-6">
                        {loading ? (
                          ...
                          <div className="text-center py-8 text-gray-500 dark:text-gray-400">
                            ...
                            <p>
                              No students have enrolled for this course yet.
                            </p>
                          </div>
                        )}
                      </TabsContent>
                  ...
                  <div className="p-6 space-y-4">
                    ...
                    {hasSignedContract ? (
                      <div className="bg-green-100 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-md p-3 flex items-center">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-green-700 dark:text-green-400">
                            You have enrolled for this course on{" "}
                      ...
                      <div className="text-sm text-gray-600 dark:text-gray-400 flex items-center">
                        ...
                        <span>
                          Please read the contract carefully before enrolling.
                        </span>
                      </div>
                    )}
                    ...
                    {!isTutor && (
                      <>
                        ...
                        <Button
                          variant="outline"
                          className="w-full border-indigo-200 dark:border-indigo-800 text-indigo-700 dark:text-indigo-300 h-12 text-base"
                          onClick={() => setIsContractDialogOpen(true)}
                    ...
                    <div className="text-xs text-gray-500 dark:text-gray-400 mt-4">
                      <p>
                        Refund Policy. You can request a complaint or cancel the
                        course, we will review and refund you if the course has
                        not started.
                      </p>
                    </div>
                  </div>
