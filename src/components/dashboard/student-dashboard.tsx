...
import { BookOpen, GraduationCap, Clock, Star, ArrowUp, Calendar, Search } from "lucide-react"
      ...
      <motion.div variants={container} initial="hidden" animate="show" className="space-y-6">
              ...
              <CardContent className="p-6">
                <div className="flex justify-between items-start">
                  <div>
                    ...
                    <h3 className="text-2xl font-bold mt-1">{mockStats.completedCourses}</h3>
                    <div className="flex items-center mt-1 text-sm">
                      <span className="flex items-center text-emerald-600 dark:text-emerald-400">
                        <ArrowUp className="h-3 w-3 mr-1" />1
                      </span>
              ...
              <CardContent className="p-6">
                <div className="flex justify-between items-start">
                  <div>
                    ...
                    <h3 className="text-2xl font-bold mt-1">{mockStats.hoursLearned}</h3>
                    <div className="flex items-center mt-1 text-sm">
                      <span className="flex items-center text-emerald-600 dark:text-emerald-400">
              ...
              <CardContent className="p-6">
                <div className="flex justify-between items-start">
                  <div>
                    ...
                    <h3 className="text-2xl font-bold mt-1">{mockStats.averageScore}%</h3>
                    <div className="flex items-center mt-1 text-sm">
                      <span className="flex items-center text-emerald-600 dark:text-emerald-400">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <motion.div variants={fadeIn("up", 0.6)}>
            <Card className="border-indigo-100 dark:border-indigo-900">
              <CardHeader>
                <CardTitle className="text-xl font-semibold">Learning Distribution</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="h-80">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <motion.div variants={fadeIn("up", 0.7)}>
            <Card className="border-indigo-100 dark:border-indigo-900">
              <CardHeader className="flex flex-row items-center justify-between">
                <CardTitle className="text-xl font-semibold">My Tutors</CardTitle>
                  ...
                  {mockTutors.map((tutor) => (
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-sm text-gray-600 dark:text-gray-400 truncate">{tutor.subject}</p>
                      </div>
          ...
          <motion.div variants={fadeIn("up", 0.8)}>
            <Card className="border-indigo-100 dark:border-indigo-900">
              <CardHeader className="flex flex-row items-center justify-between">
                <CardTitle className="text-xl font-semibold">Recommended Courses</CardTitle>
                <Button variant="outline" size="sm" asChild>
                  ...
                  {mockCourses.map((course) => (
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-sm text-gray-600 dark:text-gray-400 truncate">Tutor: {course.tutor}</p>
                      </div>
                      <Badge
                        variant="outline"
