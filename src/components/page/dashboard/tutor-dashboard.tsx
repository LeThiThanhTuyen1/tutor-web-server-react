      ...
      <div className="p-6">
        ...
        >
          ...
          <p className="text-gray-600 dark:text-gray-400">
            Đang tính toán dữ liệu của bạn...
          </p>
        </motion.div>
      </div>
    );
    ...
    <div className="p-6">
      <motion.div variants={fadeIn("up", 0.1)} initial="hidden" animate="show">
        <div className="mb-8">
          ...
          <p className="text-gray-600 dark:text-gray-400">
          Dưới đây là thống kê trong quá trình giảng dạy của bạn hiện nay.
          </p>
        </div>
      </motion.div>
          ...
          <motion.div variants={fadeIn("up", 0.7)}>
            <Card className="border-indigo-100 dark:border-indigo-900 bg-white dark:bg-gray-800">
              <CardHeader className="flex flex-row items-center justify-between">
                <CardTitle className="text-xl font-semibold">
                  Các lớp học sắp ra mắt
                </CardTitle>
                <Button variant="outline" size="sm" asChild>
                  <Link to="/tutor/courses">Xem tất cả</Link>
                </Button>
              </CardHeader>
              <CardContent>
