...
export function StudentDashboard() {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      ...
      const recommendedTutorsResponse = await getTutorRecommended();
      if (recommendedTutorsResponse.succeeded) {
        setRecommendedTutors(recommendedTutorsResponse.data || []);
      } else {
        setError(recommendedTutorsResponse.message);
      }
  ...
  return (
    <div className="p-6">
      <motion.div variants={fadeIn("up", 0.1)} initial="hidden" animate="show">
        <div className="mb-8">
          ...
          <p className="text-gray-600 dark:text-gray-400">
            Dưới đây là thống kê trong quá trình học tập của bạn hiện nay.
          </p>
        </div>
      </motion.div>
      ...
      >
            ...
            <Card className="border-indigo-100 dark:border-indigo-900 bg-white dark:bg-gray-800">
              <CardHeader className="flex flex-row items-center justify-between">
                ...
                <Button variant="outline" size="sm" asChild>
                  <Link to="/tutors">Xem danh sách gia sư</Link>
                </Button>
              </CardHeader>
              <CardContent>
          ...
          <motion.div variants={fadeIn("up", 0.8)}>
            <Card className="border-indigo-100 dark:border-indigo-900 bg-white dark:bg-gray-800">
              <CardHeader className="flex flex-row items-center justify-between">
                ...
                <Button variant="outline" size="sm" asChild>
                  <Link to="/tutors">Xem tất cả</Link>
                </Button>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                  {recommendedTutors.map((tutor) => (
                    ...
                    >
                      ...
                      <div className="flex items-center space-x-2">
                        ...
                        >
                          {tutor.compatibilityScore.toFixed(1)}% tương thích
                        </Badge>
                        <div className="flex items-center">
                          <Star className="h-4 w-4 text-amber-500 fill-current" />
                          <span className="ml-1 text-sm font-medium">
        ...
        {/*Courses Progress and Recommended Tutors */}
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
