      ...
      <div className="container mx-auto px-6 pt-16 pb-8 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          >
            ...
            Kết nối học viên với các gia sư chuyên gia để có trải nghiệm học tập được cá nhân hóa
            giúp đạt được mục tiêu học tập.
            </p>
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                ...
                <span className="text-indigo-100">
                  123 Đưuòng giáo dục, Thành phố Học tập, 10001
                </span>
              </li>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          >
            © {currentYear} TutorConnect. Mọi quyền được bảo lưu. Được thực hiện với{" "}
            <Heart className="inline-block h-3 w-3 text-red-400" /> Đội của chúng tôi.
          </motion.p>
          <motion.div
            initial={{ opacity: 0 }}
            whileInView={{ opacity: 1 }}
