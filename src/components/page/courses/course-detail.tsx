...
const MODE_ICONS: Record<string, React.ReactNode> = {
  online: <Video className="h-4 w-4" aria-hidden="true" />,
  "in-person": <MapPin className="h-4 w-4" aria-hidden="true" />,
  hybrid: <School className="h-4 w-4" aria-hidden="true" />,
};
...
export default function CourseDetail() {
  ...
  const courseBenefits = [
    {
      icon: <Clock4 className="h-4 w-4" aria-hidden="true" />,
            ...
            >
              ...
              <Card className="border border-indigo-100 dark:border-indigo-900 overflow-hidden bg-white dark:bg-gray-800">
                ...
                <CardHeader className="pb-2">
                  <div className="flex flex-wrap justify-between items-start gap-2">
                    ...
                    >
                      {translateStatus(currentCourse.status)}
                    </Badge>
                  </div>
                  <div className="flex items-center mt-2 text-sm text-gray-600 dark:text-gray-400">
                    ...
                    <span>{totalStudents || 0} học viên đã đăng ký</span>
                  </div>
                </CardHeader>
                <CardContent>
                  <p className="text-gray-600 dark:text-gray-400 mb-6">
                      ...
                      <div className="space-y-6">
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                            {Array.from({ length: 6 }).map((_, i) => (
                              <div key={i} className="flex items-start">
                                <CheckCircle
                                  className="h-5 w-5 mr-2 text-indigo-500 dark:text-indigo-400 flex-shrink-0 mt-0.5"
                                  aria-hidden="true"
                                />
                                <span className="text-gray-600 dark:text-gray-400">
                                  {i === 0
                                    ? "Nắm vững các kiến thức cơ bản của môn học"
                                    : i === 1
                                    ? "Áp dụng kỹ năng thực tế vào các tình huống thực tiễn"
                                    : i === 2
                                    ? "Phát triển khả năng tư duy phản biện và giải quyết vấn đề"
                                    : i === 3
                                    ? "Hợp tác hiệu quả với bạn học và giảng viên"
                                    : i === 4
                                    ? "Xây dựng danh mục dự án để thể hiện kỹ năng của bạn"
                                    : "Chuẩn bị cho việc học nâng cao hoặc cơ hội nghề nghiệp"}
                                </span>
                              </div>
                            ))}
                          </div>
                        ...
                        <div>
                          ...
                          <ul className="list-disc pl-5 space-y-2 text-gray-600 dark:text-gray-400">
                            <li>Hiểu biết cơ bản về môn học</li>
                            <li>
                              Khả năng truy cập các phần mềm hoặc công cụ cần
                              thiết
                            </li>
                            <li>Cam kết hoàn thành bài tập và dự án</li>
                          </ul>
                        </div>
                      </div>
                    </TabsContent>
                    ...
                    <TabsContent value="schedule" className="p-6">
                      {hasSchedules ? (
                        ...
                        <div className="text-center py-8 text-gray-500 dark:text-gray-400">
                          ...
                          />
                          <p>
                            Hiện tại không có thông tin lịch học cho khóa học
                            này.
                          </p>
                        </div>
                      )}
                          ...
                          <div className="space-y-4">
                            ...
                            >
                              <TabsList className="mb-4">
                                <TabsTrigger
                                  value="all"
                                  aria-label="Tất cả học viên"
                                >
                                  Tất cả ({studentCounts.all})
                                </TabsTrigger>
                                <TabsTrigger
                                  value="completed"
                                  aria-label="Học viên đã hoàn thành"
                                >
                                  Đã hoàn thành ({studentCounts.completed})
                                </TabsTrigger>
                                <TabsTrigger
                                  value="pending"
                                  aria-label="Học viên đang chờ"
                                >
                                  Đang chờ ({studentCounts.pending})
                                </TabsTrigger>
                              </TabsList>
              ...
              <div className="flex flex-wrap gap-2 lg:hidden">
                <Button
                  ...
                  aria-label="Xem thông tin gia sư"
                >
                  <Link
                      ...
                      <>
                        ...
                        {hasSignedContract ? (
                          ...
                          <div className="text-sm text-gray-600 dark:text-gray-400 flex items-center">
                            ...
                            />
                            <span>
                              Vui lòng đọc kỹ hợp đồng trước khi đăng ký.
                            </span>
                          </div>
                        )}
                        <Button
...
function renderStudentList(students: any[]) {
  ...
  function translateStatus(status: any): React.ReactNode {
    switch (status.toLowerCase()) {
      case "ongoing":
        return "Đang diễn ra";
      case "completed":
              ...
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
                <div>
                  ...
                  <div className="flex flex-wrap gap-x-4 gap-y-1 mt-1 text-sm">
                    ...
                    <div className="flex items-center text-gray-600 dark:text-gray-400">
                      <Mail
                        className="h-3.5 w-3.5 mr-1 text-indigo-500 dark:text-indigo-400"
                        aria-hidden="true"
                      />
